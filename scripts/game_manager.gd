...
@onready var anxiety_label = $"CanvasLayer/Control/Anxiety Frame/Label"
@onready var shader_mat = $"CanvasLayer/Control/Anxiety Frame".material # Assuming you applied a ShaderMaterial to the frame
...
func _update_ui():
	$CanvasLayer/Control/AnxietyGauge.scale.x = anxiety / 100
